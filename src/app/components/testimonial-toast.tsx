    ...
    >
      <div className="bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden">
        ...
        <div className="bg-indigo-600 px-4 py-2.5 sm:px-5 sm:py-3 flex items-center justify-between">
          <span className="text-white text-xs sm:text-sm font-medium">VoiceHubを試してみる</span>
          <button
          ...
          {step === 0 && (
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4">
                お客様の声を載せたホームページは、問い合わせ率が
                <span className="font-semibold text-indigo-600">34%向上</span>
                するというデータがあります。
              </p>
