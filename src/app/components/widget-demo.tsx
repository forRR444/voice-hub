...
const SAMPLE_DATA = [
  {
    ...
    title: "ライフコーチ",
    rating: 5,
    content: "受講3ヶ月で売上が安定。集客の仕組みが整いました。",
  },
  {
    name: "B さん",
    title: "フリーランスデザイナー",
    rating: 5,
    content: "強みが明確になり、適正価格で受注できるようになりました。",
  },
  {
    name: "C さん",
    title: "ヨガインストラクター",
    rating: 4,
    content: "SNS活用法を学び、クラスの予約が埋まるようになりました。",
  },
  {
    name: "D さん",
    title: "コンサルタント",
    rating: 5,
    content: "ブランディングが定まり、問い合わせが3倍になりました。",
  },
  {
    name: "E さん",
    title: "オンライン講座運営",
    rating: 5,
    content: "受講後アンケートが自動化され、申し込み率が向上しました。",
  },
  {
    name: "F さん",
    title: "整体院オーナー",
    rating: 5,
    content: "ホームページ経由の新規来院が安定して増えました。",
  },
  {
    name: "G さん",
    title: "カウンセラー",
    rating: 4,
    content: "フォームURLを送るだけで気軽に依頼できるのが助かります。",
  },
  {
    name: "H さん",
    title: "Webエンジニア",
    rating: 5,
    content: "埋め込みコードを貼るだけで最新の声が反映されます。",
  },
  {
    name: "I さん",
    title: "エステサロン経営",
    rating: 5,
    content: "「口コミを見て来ました」が増えて信頼感が上がりました。",
  },
];
