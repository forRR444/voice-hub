    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-[15px] text-gray-700 leading-[1.9]">
          ...
          <p>当社は、ユーザーが利用登録をする際に、Googleアカウントによる認証（Google OAuth 2.0）を通じて以下の個人情報を取得します。</p>
          <ul className="list-disc pl-5 space-y-1">
            <li>Googleアカウントに登録された氏名</li>
            <li>Googleアカウントに登録されたメールアドレス</li>
            <li>Googleアカウントに登録されたプロフィール画像</li>
          </ul>
          <p>当社がGoogleアカウントのパスワードを取得・保存することはありません。Googleアカウントの情報の取扱いについては、Google社のプライバシーポリシーもあわせてご確認ください。</p>
