...
export const metadata = {
  ...
  description:
    "VoiceHubのプライバシーポリシーです。個人情報の取り扱い、収集方法、利用目的についてご説明します。",
};
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-[15px] text-gray-700 leading-[1.9]">
          ...
          <p>
            「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名、メールアドレス、その他の記述等により特定の個人を識別できる情報及び容貌等の個人識別符号が含まれる情報を指します。
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Googleアカウントによる認証（Google OAuth
              2.0）の場合：Googleアカウントに登録された氏名、メールアドレス、プロフィール画像
            </li>
          </ul>
          <p>
            パスワードは暗号化して保存され、当社がパスワードを直接閲覧することはありません。Googleアカウントの情報の取扱いについては、Google社のプライバシーポリシーもあわせてご確認ください。
          </p>
          <p>
            また、ユーザーのお客様（以下「フォーム回答者」といいます。）が収集フォームを通じて送信する情報（氏名、職業・肩書き、写真、感想・評価等）は、ユーザーのアカウントに紐づいて保存されます。
          </p>
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li>
              フォーム回答者が収集フォームを通じて送信した個人情報については、当該フォームを設置したユーザーが個人情報保護法上の個人情報取扱事業者としての責任を負います。
            </li>
            <li>当社は、ユーザーの委託に基づき、フォーム回答者の個人情報を保管・処理します。</li>
            <li>
              当社は、ユーザーのウィジェット設定に基づき、ユーザーが承認したフォーム回答者の情報をユーザーの外部ウェブサイト上に表示します。
            </li>
            <li>
              フォーム回答者が自身の個人情報の開示・訂正・削除を希望する場合は、当該フォームを設置したユーザーに直接お問い合わせください。ユーザーの特定が困難な場合は、当社の問い合わせ窓口にご連絡いただくことも可能です。
            </li>
          </ol>
          ...
          <p>
            当社は、本サービスの提供にあたり、以下の外部サービスを利用しており、これらのサービス提供元に対して個人情報の取扱いを委託する場合があります。
          </p>
          <div className="overflow-x-auto mt-4">
            <table className="w-full text-sm border border-gray-200">
              <thead>
                <tr className="bg-gray-50">
                  <th className="text-left px-4 py-2 border-b border-gray-200 font-medium">
                    サービス名
                  </th>
                  <th className="text-left px-4 py-2 border-b border-gray-200 font-medium">
                    提供元
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li>
              本サービスにおけるユーザーおよびフォーム回答者の個人データは、本サービスの提供に必要な範囲で、米国に所在するサーバーに保存・処理される場合があります。
            </li>
            <li>
              当社は、委託先サービスの選定にあたり、個人情報の保護について適切な措置を講じている事業者であることを確認しています。
            </li>
          </ol>
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li>
              本サービスでは、ユーザーの認証状態の維持およびサービス改善のため、Cookie及びこれに類する技術を使用します。
            </li>
            <li>
              当社は、アクセスログ（IPアドレス、ブラウザ種別、アクセス日時等）を収集する場合があります。これらの情報は単独で個人を特定するものではありませんが、サービスの安定運用・不正アクセスの検知等に利用します。
            </li>
            <li>
              当社は、サービス改善を目的として、Google Analytics および PostHog
              を用いてユーザーの操作情報（ページ閲覧、クリック、スクロール等）を収集・分析します。PostHog
              ではセッション録画（画面操作の録画）を行う場合があります。これらの情報はサービスの品質向上のみに利用し、個人を特定する目的では使用しません。
            </li>
            <li>
